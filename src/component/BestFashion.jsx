    ...
    return (
        <div>
            <Container className="relative max-w-[1320px]">
                <div className='grid grid-cols-2 gap-3 md:gap-32 items-center md:pt-60 pb-24 md:pb-[371px]'>
                    <div className='col-span-1'>
                        <Img src={bast} />
                    </div>
                    <div className='col-span-1 '>
                        <Title className={'md:w-[437px]'} titleName={'Best Fashion Since 2024'} />
                        <p className=' md:text-2xl text-[9px] font-semibold font-common text-black md:pt-16  md:w-[443px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Arcu, odio pellentesque mattis pulvinar felis. At arcu ornare rhoncus, elementum non viverra. </p>
                    </div>
                    <div className='absolute bottom-0 left-1/2 -translate-x-1/2 md:-translate-x-full  md:bottom-52 md:left-full md:right-0 min-w-60 md:w-[793px] bg-[#FEECC8] md:rounded-[20px] -z-10'>
